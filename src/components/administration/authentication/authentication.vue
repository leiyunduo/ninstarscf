        ...
        <div class="flex-list">
          <div class="table_left">
            <ul>
              ...
              <li :class="bank_active === false ? '' : 'yes_list'">
                <span v-if="bank_active === false">4</span>
                <span v-if="bank_active === true"><img src="../../../../static/img/authentication/yes.png" alt=""></span>
                <p></p>
              </li>
              <li :class="signed === false ? '' : 'yes_list'">
                <span v-if="signed === false">5</span>
                <span v-if="signed === true"><img src="../../../../static/img/authentication/yes.png" alt=""></span>
              </li>
            </ul>
            <!-- <ul>
              <li>
                <img src="../../../../static/img/icon2.png" alt="" v-show="person_verified === 1">
                <img src="../../../../static/img/icon2.png" alt="" v-show="person_verified !== 1">
                <span>1</span>
                <p></p>
              </li>
              <li>
                <img src="../../../../static/img/icon3.png" alt="" v-show="company_verified === 1">
                <img src="../../../../static/img/icon2.png" alt="" v-show="company_verified !== 1">
                <span>2</span>
                <p></p>
              </li>
              <li>
                <img src="../../../../static/img/icon3.png" alt="" v-show="legal_person_verified === 1">
                <img src="../../../../static/img/icon2.png" alt="" v-show="legal_person_verified !== 1">
                <span>3</span>
                <p></p>
              </li>
              <li>
                <img src="../../../../static/img/icon3.png" alt="" v-show="bank_active === false">
                <img src="../../../../static/img/icon2.png" alt="" v-show="bank_active === true">
                <span>4</span>
                <p></p>
              </li>
              <li>
                <img src="../../../../static/img/icon3.png" alt="" v-show="signed === false">
                <img src="../../../../static/img/icon2.png" alt="" v-show="signed === true">
                <span>5</span>
              </li>
            </ul> -->
          </div>
          <div class="table_list">
            ...
            <div class="tab_bor">
              ...
              <div class="tab_right">
                <button size="mini" :disabled="company_verified !== 4 || legal_person_verified !== 4 || person_verified !== 4" :class="[{active: company_verified !== 4 || legal_person_verified !== 4 || person_verified !== 4}, {btn_class: bank_active === true}]" @click="startOver">
                  <!-- <img v-if='bank_active === true' src="../../../../static/img/authentication/dui.png" alt=""> -->
                  <span :class="bank_active === false ? 'span_color' : bank_active === true ? 'span_color_yes' : 'span_color_other'">{{ bank_active === true ? startOvers = '已激活' : startOvers = '开始激活' }}</span>
                </button>
            ...
            <div class="tab_bor">
              ...
              <div class="tab_right">
                <button size="mini" :disabled="bank_active === false" :class="[{active: bank_active === false}, {btn_class: signed === true}]" @click="sign">
                  <!-- <img v-if='signed === true' src="../../../../static/img/authentication/dui.png" alt=""> -->
...
export default {
  ...
  mounted () {
    ...
    if (that.$route.query.id) {
      that.legal_id = that.$route.query.id
    }
    that.$ajax.get('/api/company/status/').then(res => {
      ...
      that.bank_active = res.data.bank_active
  ...
  methods: {
    ...
    firstOne () {
      ...
      if (that.change_apply === false) {
        if (that.company_verified === 1) {
          let URL = (that.legal_id) ? '/authenticationFirst?id=' + that.legal_id : '/authenticationFirst'
          // 填写数据
          that.$router.push({
            path: URL
          })
    ...
    selectAuth (i) {
      ...
      if (that.change_apply === false) {
        if (i === -1) {
          let URL = (that.legal_id) ? '/authLegalOne?id=' + that.legal_id : '/authLegalOne'
          // 审核失败
