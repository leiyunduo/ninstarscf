  ...
  <div class="view_chain">
    <div class="line_detail">
      ...
      <div class="chainNavLine" v-show="selIndex === 0" :style="element ? ' box-shadow: 0 2px 8px rgba(0, 0, 0, 0.15);' : ''">
        <ring :chainId="chainId" :chainType="2" :element="element"/>
      </div>
...
import OrderOne from '@/components/chain-view/base/chain_modules/chain_order1'
import OrderTwo from '@/components/chain-view/base/chain_modules/chain_order2'
...
.chain-flex {
  ...
  .chain-flex__icon_warning {
    background: #fff;
    animation: twinkle1 .7s ease-in-out 0s infinite;
    -moz-animation: twinkle1 .7s ease-in-out 0s infinite;
    -webkit-animation: twinkle1 .7s ease-in-out 0s infinite;
    // margin-bottom: 6px
  }
  &>.twinkle {
    width: 22px;
...
//     }
//   }
// @-webkit-keyframes diamondBright
//   {
//     0%{
//       filter: brightness(90%)
//     }
