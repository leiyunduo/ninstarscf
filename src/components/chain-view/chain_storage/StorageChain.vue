      ...
      <div v-if="selIndex === 0" class="chain_list">
        <div class="bottom">
          <dl>
            ...
            <dt>
              <img class="barIcon" src="static/img/tickets/jq_01.png" alt="">
            </dt>
            <dd>
          ...
          <dl>
            <dt><img class="barIcon" src="static/img/tickets/yq_01.png" alt=""></dt>
            <dd>
          ...
          <dl>
            <dt><img class="barIcon" src="static/img/tickets/tq_01.png" alt=""></dt>
            <dd>
