  ...
  <div class="riskManagement">
    ...
    <div class="enterprise_credit_list">
      ...
      <div class="enterprise-list-credit">
        ...
        <div class="h3_list">
          <div class="left">
            <div class="credit-grade" style="padding-bottom:20px; height:346px;">
              <h4>供应商信用评估</h4>
              <div class="business_grade" v-for="(item, index) in supplierName.slice((currentPage - 1) * 3, currentPage * 3)" :key="index">
          ...
          <div class="right">
            <div class="credit-grade" style="padding-bottom:20px; height:346px;">
              <h4>客户信用评级</h4>
              <div class="business_grade" v-for="(item, index) in businessName.slice((currentPage1 - 1) * 3, currentPage1 * 3)" :key="index">
                <div class="business_name">{{item.name}}</div>
                <ul>
...
export default {
  ...
  mounted () {
    ...
    that.$ajax.get('/api/oth/data_portrait/partner_company/?company_id=' + that.company_id + '&p_type=1').then(res => {
      ...
      that.total1 = Number(res.data.length)
