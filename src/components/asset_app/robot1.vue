    ...
    <div class="c_robot">
      ...
      <div class="c_top_box">
        <div class="c_move_img">
          <img class="c_header01" @mouseenter="isShowLine(1)" @mouseleave="notLine()" :class="hoverData.showFinaceLine ? 'active' : ''" src="static/img/robot/header102.png" alt="">
          <img class="c_header04" @mouseenter="isShowLine(3)" @mouseleave="notLine()" :class="hoverData.showFinaceLine ? 'active' : ''" src="static/img/robot/header102.png" alt="">
          <img class="c_header05" @mouseenter="isShowLine(2)" @mouseleave="notLine()" :class="hoverData.showFinaceLine ? 'active' : ''" src="static/img/robot/header102.png" alt="">
          <img class="c_header06" @mouseenter="isShowLine(4)" @mouseleave="notLine()" :class="hoverData.showFinaceLine ? 'active' : ''" src="static/img/robot/header102.png" alt="">
          <img class="c_header02" src="static/img/robot/header103.png" alt="">
          <img class="c_header03" src="static/img/robot/header104.png" alt="">
          <!-- <img class="c_header04" @mouseenter="isShowLine(4)" @mouseleave="notLine()" :class="hoverData.showArapLine ? 'active' : ''" src="static/img/robot/header104.png" alt=""> -->
      ...
      <div class="c_head_box">
        <div class="c_move_img">
          <img class="c_earl" @mouseenter="isShowLine(5)" @mouseleave="notLine()" :class="hoverData.showArLine ? 'active' : ''" src="static/img/robot/earl1.png" alt="">
          <img class="c_earr" @mouseenter="isShowLine(6)" @mouseleave="notLine()" :class="hoverData.showAyLine ? 'active' : ''" src="static/img/robot/earl1.png" alt="">
        </div>
        <div class="c_left">
          <!-- 应收卡片 -->
          <div class="c_position_box">
       ...
       <div class="c_body_box1">
         <div class="c_move_img">
          <img class="c_hand02" @mouseenter="isShowLine(7)" @mouseleave="notLine()" :class="hoverData.showDepositLine ? 'active ' : ''" src="static/img/robot/hand102.png" alt="">
        </div>
        <div class="c_right">
          <!-- 存单卡片 -->
          <div class="c_position_box">
      ...
      <div class="c_body_box2">
        <div class="c_move_img">
          <img class="c_body" src="static/img/robot/ninstar2.png" alt="">
          <img class="c_hand01" src="static/img/robot/hand101.png" alt="">
          <img class="c_ninstar" @mouseenter="isShowLine(9)" @mouseleave="notLine()" :class="hoverData.showAssetLine ? 'active' : ''" src="static/img/robot/ninstar1.png" alt="">
          <img class="c_hand02" src="static/img/robot/hand101.png" alt="">
        </div>
        <div class="c_left">
          <!-- 存货卡片 -->
          <div class="c_position_box">
      ...
      <div class="c_foot_box">
        <div class="c_move_img">
          ...
          <img class="c_foot01" src="static/img/robot/foot01.png" alt="">
          <img class="c_foot02" src="static/img/robot/foot01.png" alt="">
          <img class="c_foot03" src="static/img/robot/foot01.png" alt="">
        </div>
        <div class="c_position_box">
  ...
  .c_robot {
    ...
    .c_position_box{
      ...
      .c_asset_line{
        ...
        border-right: 1px solid #93d9ff;
        position: absolute;
        top: 28px;
        left: 0px;
        border-radius: 0 8px;
        &.active{
          border-top: 1px dashed #93d9ff;
          border-right: 1px dashed #93d9ff;
        }
        i{
          background: #93d9ff;
          bottom: -3px;
      ...
      .c_banck_cridit_line{
        ...
        width: 215px;
        height: 50px;
        border-top: 1px solid rgba(85, 102, 188, 0.88);
        border-left: 1px solid rgba(85, 102, 188, 0.88);
        position: absolute;
        top: -50px;
        left: 68px;
        border-radius: 8px 0;
      ...
      .c_num_cridit_line{
        ...
        height: 50px;
        border-top: 1px solid rgba(85, 102, 188, 0.88);
        border-right: 1px solid rgba(85, 102, 188, 0.88);
        position: absolute;
        top: -50px;
        right: 256px;
        border-radius: 0 8px;
