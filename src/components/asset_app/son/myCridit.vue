      ...
      <div class="c_pay_item">
        <div class="list-pay">
          <div :title="'应收：' + toTenThousand(receivable.total.value)">
            <span>应收(万元)：</span>
            <span>{{toTenThousand(receivable.total.value)}}</span>
          </div>
          <div :title="'总逾期率：' + (receivable.total.overdue_rate) + '%'"><span>总逾期率：</span><span>{{(receivable.total.overdue_rate) + '%'}}</span></div>
        </div>
        <div class="list-pay">
          <div :title="'已收：' + toTenThousand(receivable.receive.value)">
            <span>已收(万元)：</span><span>{{toTenThousand(receivable.receive.value)}}</span>
          </div>
          <div :title="'' + receivable.receive.overdue_rate">
          </div>
        </div>
        <div class="circle-pro">
          <el-progress type="circle" :stroke-width='18' :percentage="Number(receivable.total.overdue_rate)" color="#EB6100"></el-progress>
        </div>
      </div>
      <div class="c_pay_item">
        <div class="list-pay">
        ...
        <div class="list-pay">
          ...
          <div :title="'逾期率：' + payable.paid.overdue_rate"></div>
        </div>
        <div class="circle-pro">
          <el-progress type="circle" :stroke-width='18' :percentage="Number(payable.total.overdue_rate)" color="#0C8DFF"></el-progress>
        </div>
      </div>
    </div>
    <div class="all">
