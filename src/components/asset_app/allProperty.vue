<template>
  <div class="all">
    ...
    <!-- <div class="chart-title">我的应收信用</div>
    <div class="show-chart"></div>
    <div id="pie-getting" class="show-chart"></div>
    <div class="chart-title">我的应付信用</div>
    <div id="month-paying" class="show-chart"></div>
    <div id="pie-paying" class="show-chart"></div>
    <div class="chart-title">我的存单/存货信用</div>
    <div id="month-stock" class="show-chart"></div>
    <div id="pie-stock" class="show-chart"></div> -->
  </div>
</template>
<script>
// 引入echarts
