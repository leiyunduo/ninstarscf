      ...
      <div class='assets_content' @click="handlehide($event)">
        ...
        <div class="c_assets_bottom">
          ...
          <div class='table_list'>
            ...
            <div class="bottom">
              <tableTab :selType='selectName' v-if="isActiveBtn === 0" />
              <!-- <applicationSolving :selType='selectName' v-if="isActiveBtn === 1" /> -->
              <risk :selType='selectName' v-if="isActiveBtn === 1" />
              <prosess :selType='selectName' v-if="isActiveBtn === 2" />
              <refuse :selType='selectName' v-if="isActiveBtn === 3" />
            </div>
          </div>
        </div>
        <!-- <div class="c_assets_bottom">
          ...
          <ul>
            <li v-for='(item, index) in titleList' :key='index'>
              ...
              <div>{{Number(item.value).toFixed(2)}}（万元）</div>
            </li>
          </ul>
          <div class='table_list'>
            <div class="top">
