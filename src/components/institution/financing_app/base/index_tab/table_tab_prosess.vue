...
export default {
  ...
  methods: {
    handleAjax (page, page_size, type) {
      ...
      this.$ajax.get(`/api/financing/loan_process/?is_active=1&loan_process_status__in=${'200,201,300,301,400,401,500,501,502'}&page=${page}&page_size=${pz}&financing_application__type=1`).then(res => {
        if (res.status === 200) {
