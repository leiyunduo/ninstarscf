  ...
  <div class="view_chain">
    ...
    <div class="line_detail">
      ...
      <div v-if="selIndex === 2" class="chain_list">
        ...
        <data-analyse v-if='dataTime === 0' :bigData="bigData" />
...
import RoleRegister from '@/components/chain_app/chain_roles/PaymentRoleRegister'
import paymentSupply from '@/components/chain_app/chain_supply/PaymentSupplyRegister'
// 大数据资产与分析
import timeModel from '@/components/chain_app/chain_roles/timeModel'
import dataAnalyse from '@/components/chain_app/chain_roles/bigDataAnalyse'
import Attachments from '@/components/chain_app/chain_attachments/PaymentAttchements'
export default {
  name: 'chain_line',
  components: {
    // appNav, 
    Location, Contract, Order, Settlement, SettlementContract, RoleRegister, paymentSupply, Attachments, timeModel, dataAnalyse
  },
  data () {
    return {
      showNav: false,
