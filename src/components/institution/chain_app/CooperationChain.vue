...
import RoleRegister from '@/components/chain_app/chain_roles/ReceiveRoleRegister'
import paymentSupply from '@/components/chain_app/chain_supply/ReceiveSupplyRegister'
// 大数据资产与分析
...
import Attachments from '@/components/chain_app/chain_attachments/ReceiveAttachments'
export default {
  name: 'chain_line',
  components: {
    // appNav, 
    Location, Contract, Order, Settlement, SettlementContract, RoleRegister, paymentSupply, timeModel, dataAnalyse, Attachments
  },
  data () {
    return {
      isSure: false,
