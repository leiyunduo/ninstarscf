    ...
    <div class="line_detail">
      ...
      <div class="chain_list">
        <div class="chain-box">
              ...
              <div class="chain-container">
                <div class="first_view" v-show="userType === 'business'">
                  <div class="first_chain">
                    ...
                    <contract  :type="`1`" :idList="id_list" :confirmId="cooperation_id" :id='contract_id'/>
                  </div>
                </div>
                <div class="second_view">
                  <div class="second_chain">
                    <div class="chain_title">
                      ...
                      <span>{{userType === 'serviceprovider' ? 'B2B仓储及物流': 'B2B电子订单'}}</span>
                    </div>
                    <div v-if="isService">
          ...
          <div class="modal-wrap" v-show="isShowModal">
              ...
              <div class="modal__box">
                ...
                <div class="modal-body confirm">
                  <span class="desc_text">
                    确认说明：您好（北京小小影业有限公司），感谢您为合作企业的记账内容进行确认，确认后将增加您合作企业的记账信用。同时平台将会记录您的本次操作，当合作企业（北京高升数据系统有限公司）进行融资申请时相关的金融、助贷等服务机构将会看到您的确认信息，请谨慎您的操作。
                  </span>
                </div>
              </div>
              <div class="modal__box">
          ...
          <div class="modal-wrap" v-show="isShowRejectModal">
            <div class="modal-inner reject_reason">
              <div class="modal__box">
                <div class="modal-title reject">
...
import Contract from '@/components/claim_app/base/claim_cooperation/claim_modules/confirm_contract'
import Order from '@/components/claim_app/base/claim_cooperation/claim_modules/confirm_order'
import Service from '@/components/claim_app/base/claim_cooperation/claim_modules/confirm_service'
import Settlement from '@/components/claim_app/base/claim_cooperation/claim_modules/confirm_settlement'
import SettlementContract from '@/components/claim_app/base/claim_cooperation/claim_modules/confirm_settlement_contract'
...
export default {
  ...
  methods: {
    ...
    modalConfirm (type) {
      ...
      this.$ajax.patch(`/api/chain/co_confirm/${this.cooperation_id}/choices/`, {'choices': type}).then(res => {
        if (res.status === 200) {
  ...
  beforeCreate: function () {
    ...
    if (that.claim === 1) {
      ...
      that.location = [
        {title: '协同展示', url: '/chain_app/chain_main?type=4'},
        {title: '协同确认'}
      ]
    }
