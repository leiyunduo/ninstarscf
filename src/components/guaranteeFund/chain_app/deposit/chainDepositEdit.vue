        ...
        <div class="chain-deposit__form chain_flex">
          <div class="chain-deposit__form__group chain-width-r3">
            ...
            <div class="chain-deposit__form__row chain-from_select">
              ...
              <el-select size="small" v-model="deposit.pay_type" :disabled="isDisabled.pay_type" @change="changeTab(deposit.pay_type)" :placeholder="showVal(deposit.pay_type)">
                <el-option label="现金" value="1"></el-option>
                <el-option label="支票" value="2"></el-option>
                <el-option label="汇票 (银行承兑汇票汇)" value="3"></el-option>
