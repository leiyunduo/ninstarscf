<template>
  <div class="view_chain">
    ...
    <div class="nav_chain_top" v-if="element">
      <div class="topLocation">
        <location :location="location"></location>
      </div>
      <!-- <nav-chain-line v-if="selIndex === 0" :chainId='chainId' ref="child" :dataNav='data_nav' @checkState='checkNavState' @toAnchorPlace='toAnchorPlace'></nav-chain-line> -->
    </div>
    <div class="line_detail">
      ...
      <!-- <div class="c_order_info">
        <div class="c_order_info_inner">
          <p v-if="related[0].length !== 0">
            <span>合同名：{{related[0][0].name}}</span>
            <span>交易公司：{{related[0][0].partner}}</span>
            <span>创建时间：{{related[0][0].date_created}}</span>
          </p>
        </div>
      </div> -->
      <!-- <div class="navChainLine" v-if="!element">
        <nav-chain-line v-if="selIndex === 0" :chainId='chainId' ref="child" :dataNav='data_nav' @checkState='checkNavState' @toAnchorPlace='toAnchorPlace'></nav-chain-line>
      </div> -->
      <ul class="view_nav">
        ...
        <div class="chain-box">
          <div class="chain-box__item">
            ...
            <div class="chain-box__item__content">
              <div class="chain-container border_hide">
                <div class="first_view border_show">
                  <div class="first_chain">
                    ...
                    <contract :chainType="`2`" :type="`1`" :contractType="`1`" :id='chainId' @changeId='handleChild'/>
                  </div>
                </div>
              </div>
              <div class="chain-box__item__title">
              ...
              <div class="chain-container">
                <div class="first_view">
                  <div class="first_chain">
                    ...
                    <contract :chainType="`2`" :type="`2`" :id='chainId' :contractType="`2`"  @changeId='handleChild'/>
                  </div>
                </div>
                <div class="second_view">
                  <div class="second_chain">
                    ...
                    <order :chainType="`2`" :type="`2`" :id='contractIds.payment' @changOrderId="updataOrderId"/>
                  </div>
                  <div class="second_chain">
                    <div class="chain_title">
                      <div class="symbol_middle_blue"><div></div></div>
                    ...
                    <settlement :chainType="`2`" :type="`2`" :id='contractIds.payment' :orderId="orderIds.payment"/>
                  </div>
                  <div class="second_chain">
                    <div class="chain_title">
                      <div class="symbol_middle_blue"><div></div></div>
              ...
              <div class="chain-box__item__title">
                <span class="chain-box_show">关联销售登记</span>
                <img src="static/img/chain/chaindown1.png" alt="">
              </div>
              <div class="chain-container border_hide">
                <div class="second_view">
                  <div class="second_chain extend_border">
                    <div class="chain_title">
                      <div class="placeholder"></div>
                      <div class="symbol_middle_orange"><div></div></div>
                      <span>B2B电子订单登记</span>
                    </div>
                    <order :chainType="`2`" :type="`1`" :id='contractIds.receive' @changOrderId="updataOrderId"/>
                  </div>
                  <div class="second_chain extend_border">
                    <div class="chain_title">
                      <div class="symbol_middle_orange"><div></div></div>
                    ...
                    <settlement :chainType="`2`" :type="`1`" :id='contractIds.receive' :orderId="orderIds.receive"/>
                  </div>
                  <div class="second_chain extend_border">
                    <div class="chain_title">
                      <div class="symbol_middle_orange"><div></div></div>
          ...
          <div class="retaled">
            ...
            <div class="related_list" v-if="!down2">
              ...
              <div class="related_item" v-for="(title, index) in titleList" :key="index" v-if="index > 6">
                ...
                <div class="item_info">
                  <div class="item_card" v-if="index === 7">
                    <div class="item_sec_title">参与角色</div>
                  ...
                  <div class="item_card" v-if="index === 8">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                  ...
                  <div class="item_card" v-if="index === 9">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                  ...
                  <div class="item_card" v-if="index === 10">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                      <div class='item_title1'>运单编号【{{tr.name}}】</div>
                      <div class="teble_title" >
                  ...
                  <div class="item_card" v-if="index === 11">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                  ...
                  <div class="item_card" v-if="index === 12">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                      <div class='item_title1'>结算编号【{{tr.name}}】</div>
                      <div class="teble_title" >
                  ...
                  <div class="item_card" v-if="index === 13">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                  ...
                  <div class="item_card" v-if="index === 14">
                    <div class="item_sec_title">参与角色</div>
                    <div class="item_table"  v-for="(tr, trIndex) in recordPay[index]" :key="trIndex">
                      <div class='item_title1'>支付编号【{{tr.name}}】</div>
                      <div class="teble_title" >
      ...
      <div v-if="selIndex === 3" class="chain_list c_tab_3">
        ...
        <div class="chain">
                ...
                <div class="item_card">
                  <div class="item_table" v-for="(file, fileIndex) in files[index]" :key='fileIndex' v-if="file.length !== 0">
                    ...
                    <div class="table_line" v-for='(tr, tLine) in file' :key='tLine'>
                      ...
                      <div style="font-size: 14px; line-height: 36px;">{{tr.is_supply ? tr.is_supply : tr.content_obj_name}}</div>
          ...
          <div class="card_title">
            <span>关联采购登记<i class="c_bg_down" @click='down3 = !down3' :style="down3 ? 'transform:rotateZ(180deg);' : 'transform:rotateZ(0);'"></i></span>
          </div>
          <div class="card_list" v-if="!down3">
            <div class="card_item" v-for="(title, index) in titleList" :key="index" v-if="index> 6">
              <div class="item_title">
...
// import navChainLine from '../base/public/ChainCursorPayLine'
...
export default {
  ...
  data () {
    return {
      ...
      is404: -1,
      navList: [
        {name: '链式记账', path: '/chainview/list'},
        {name: '参与角色与记录', path: '/chain/role'},
        {name: '大数据资产与分析', path: '/chainview/chart'},
        {name: '单证与票据原件', path: '/chainview/file'},
        {name: '补充', path: '/chainview/info'}
      ],
      tableTitle: [
        ['合同名称', '交易公司', '创建时间', '交易金额'],
        ['支付状态', '订金金额', '订金比例', '支付行'],
  ...
  methods: {
    ...
    changeTab: function ($event, index) {
      var that = this
      // that.$loading(that.$setLoading())
      that.selIndex = index
      //  // console.log(that.chainId)
      if (index === 1) {
        that.$ajax.get('/api/chain/ledger_log/?token=' + that.$token() + '&chain_id=' + that.chainId).then(res => {
          ...
          if (res.data.code === '1') {
            ...
            if (res.data.data.payable_contract.length !== 0) {
              ...
              recordPay[5] = []
              res.data.data.payable_contract[0].financing_plan_role_record ? recordPay[6] = [res.data.data.receivable_contract[0].financing_plan_role_record] : recordPay[6] = []
  ...
  mounted: function () {
    ...
    if (that.$route.query.showTab) {
      ...
      if (Number(that.$route.query.showTab === 1) && (that.$route.query.from) === 'business') {
