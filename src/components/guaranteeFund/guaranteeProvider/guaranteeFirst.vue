<template>
  <div class="guaranteeFirst">
    <div class="info-enter">
      ...
      <guarantee-second v-if='nextData === 1' @nextDataShow='nextDataShow' :putId='putId' :certificateList='certificate' @dataLast='dataLast' :contact_info='contact_info' :nextCompany='nextCompany' :area='area' :opening_bank_info='opening_bank_info' :nextData='nextData' :ruleFormFirst='ruleForm' />
      <div class="right" v-if='nextData === 0'>
        ...
        <div class="basicsList">
          <el-form :model="opening_bank_info" ref="ruleFormT" class="demo-ruleForm" label-position='left' size="small">
            ...
            <el-form-item label="银行账户所在地：" prop="bank_province" label-width="200px" v-if='eId !== 1'>
            ...
            <el-form-item label="银行账户所在地：" prop="bank_province" v-if='eId === 1' label-width="189px">
          ...
          <!-- <el-form :model="opening_bank_info" v-if="eId === 1" ref="ruleFormT" class="demo-ruleForm" label-position='left' size="small">
            <el-form-item label="开户行：" prop="opening_bank" v-if='opening_bank_info.opening_bank' label-width="200px">
              <el-input v-model="opening_bank_info.opening_bank" style="width: 370px;" :class="{disTables: disTable}" :disabled="disTable"></el-input>
            </el-form-item>
            <el-form-item label="银行账户所在地：" prop="bank_province" v-if='opening_bank_info.bank_region' label-width="189px">
              <el-input v-model="opening_bank_info.bank_province" style="width: auto;" :class="{disTable: disTable}" :disabled="disTable"></el-input>
              <el-input v-model="opening_bank_info.bank_city" style="width: auto;" :class="{disTable: disTable}" :disabled="disTable"></el-input>
              <el-input v-model="opening_bank_info.bank_region" style="width: auto;" :class="{disTable: disTable}" :disabled="disTable"></el-input>
            </el-form-item>
            <el-form-item label="分行名称：" prop="bank_branch" v-if="opening_bank_info.bank_branch" label-width="200px">
              <el-input v-model.trim="opening_bank_info.bank_branch" :class="{disTable: disTable}" :disabled="disTable" style="width: 370px;" @focus="bankFacus" :maxlength="maxlength * 4"></el-input>
              <span class="bank_prompt" v-show="bankShow">
                例如：交通银行股份有限公司北京中关村园区支行
              </span>
            </el-form-item>
            <el-form-item label="账号名称：" prop="bank_account_name" v-if="opening_bank_info.bank_account_name" label-width="200px">
              <el-input v-model.trim="opening_bank_info.bank_account_name" :class="{disTable: disTable}" :disabled="disTable" style="width: 370px;" @focus="accountFacus" :maxlength="maxlength"></el-input>
              <span class="bank_prompt" v-show="accountShow">
                例如：九星惟诚供应链信息技术（北京）有限公司
              </span>
            </el-form-item>
            <el-form-item label="银行账号：" prop="bank_account" label-width="200px" v-if="opening_bank_info.bank_account">
              <el-input v-model.trim="opening_bank_info.bank_account" :class="{disTable: disTable}" :disabled="disTable" style="width: 370px;" @focus="bankNumFacus" :maxlength="maxlength"></el-input>
              <span class="bank_prompt" v-show="bankNumShow">
                例如：1100612410*******8943
              </span>
        ...
        <div class="basicsList">
          <el-form :model="contact_info" :rules="rules" ref="ruleForm" label-position='left' size="small">
            <el-form-item label="联系地址:" prop="address" label-width="189px">
            ...
            <el-form-item label="公司邮箱:" prop="email" label-width="189px">
            ...
            <el-form-item label="邮政编码:" prop="postal_code" label-width="189px">
            ...
            <el-form-item label="公司电话:" prop="company_phone" label-width="189px">
            ...
            <el-form-item label="公司传真:" prop="fax" label-width="189px">
            ...
            <el-form-item label="公司网址:" prop="website" label-width="189px">
          ...
          <!-- <el-form :model="contact_info" v-if="eId === 1" ref="ruleForm" label-position='left' size="small">
            <el-form-item label="联系地址:" prop="address" label-width="189px" v-if="contact_info.address">
              <el-input v-model.trim="contact_info.address" style="width: 370px;" :class="{disTable: disTable}" :disabled="disTable" :maxlength="maxlength * 2"></el-input>
            </el-form-item>
            <el-form-item label="公司邮箱:" prop="email" v-if="contact_info.email" label-width="189px">
              <el-input v-model.trim="contact_info.email" style="width: 370px;" :class="{disTable: disTable}" :disabled="disTable" :maxlength="maxlength"></el-input>
            </el-form-item>
            <el-form-item label="邮政编码:" prop="postal_code" v-if="contact_info.postal_code" label-width="189px">
              <el-input v-model.trim="contact_info.postal_code" style="width: 370px;" :class="{disTable: disTable}" :disabled="disTable" :maxlength="maxlengths / 2"></el-input>
            </el-form-item>
            <el-form-item label="公司电话:" prop="company_phone" v-if="contact_info.company_phone" label-width="189px">
              <el-input v-model.trim="contact_info.company_phone" @blur="companyPhone(contact_info.company_phone)" style="width: 370px;" :class="{disTable: disTable}" :disabled="disTable" :maxlength="maxlength / 2"></el-input>
            </el-form-item>
            <el-form-item label="公司传真:" prop="fax" v-if="contact_info.fax" label-width="189px">
              <el-input v-model.trim="contact_info.fax" style="width: 370px;" :class="{disTable: disTable}" :disabled="disTable" :maxlength="maxlength"></el-input>
            </el-form-item>
            <el-form-item label="公司网址:" prop="website" v-if="contact_info.website" label-width="189px">
              <el-input v-model.trim="contact_info.website" style="width: 370px;" :class="{disTable: disTable}" :disabled="disTable" :maxlength="maxlength * 4"></el-input>
            </el-form-item>
          </el-form> -->
...
import guaranteeSecond from './guaranteeSecond'
export default {
  data () {
    return {
      id: '',
  ...
  methods: {
    ...
    okStep () {
      const that = this
      let URL = (that.legal_id) ? '/setting?id=' + that.legal_id : '/setting?signed=1'
      ...
      if (that.eId) {
        if (that.eId === 1) {
          ...
          that.$refs['ruleFormO'].validate(valid1 => {
            that.$refs['ruleForm'].validate(valid2 => {
              if (valid1 && valid2) {
