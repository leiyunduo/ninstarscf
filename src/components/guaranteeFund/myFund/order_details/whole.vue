...
export default {
  ...
  components: {
    location, 
    // AppNav, 
    orderRisk, orderAgreement, orderLoan, orderLoan, orderRepayment
  },
  data () {
    return {
      selIndex: 0,
      currentIndex: 0,
      steps: [
        {name: '风控审核', icon: require('../../../../../static/img/financing/risk.png')},
        {name: '三方协议', icon: require('../../../../../static/img/financing/agreement.png')},
        {name: '放款', icon: require('../../../../../static/img/financing/loan.png')},
        {name: '还款', icon: require('../../../../../static/img/financing/repayment.png')}
      ],
      location: [
