  ...
  <div class="creditor_table">
    <div class='application_table'>
      ...
      <div v-for="(financing, index) in financingList" :key='index' class="table_line">
        ...
        <div v-if="selStatus === '0'">
        </div>
        <div v-if="selStatus === '4'">
        </div>
      </div>
  ...
  data () {
    return {
      titles: [
        ...
        {title: '信贷员', key: 'financing_type'},
        {title: '融资进度', key: 'loan_status'},
        {title: '申请金额', key: 'usage'},
        {title: '贷款期限', key: 'first_repayment'},
        {title: '操作'}
      ],
      nullTip: {
        "0": '已拒绝',
...
.creditor_table {
  ...
  .application_table {
    ...
    .table_line {
      ...
      &>div:nth-child(4),div:nth-of-type(5) {
        padding: 0 10px;
        span {
          text-align: right;
        }
