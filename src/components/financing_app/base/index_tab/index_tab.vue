  ...
  <div class="assetsList">
    <div class="bottom_list">
      <div v-for="(item, index) in showList" :key='index'>
        ...
        <div class="bottom_bottom" v-if="selType === '0'">
          <el-row :gutter="0">
              ...
              <div class="el_col_list el1" v-if="item.application_data">
                ...
                <div v-if="item.is_region_code && item.loan_process_info">
                  ...
                  <ul v-if="item.loan_process_info.length !== 0" class="institution_line">
                    <li v-for="(loan, indexLoan) in item.loan_process_info" :key='indexLoan'>
                      <span>{{loan.institution_name}}</span>
                      <span>{{loan.loan_process_status_display}}</span>
                    </li>
                  </ul>
                </div>
                <div v-if="!item.is_region_code && item.loan_process_info">
        ...
        <div class="bottom_bottom" v-if="selType === '1'">
          <el-row :gutter="0">
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <div class="el_col_list el1" v-if="item.application_data">
                <h3 v-if="item.application_data">
            ...
            <el-col :xs="4" :sm="4" :md="4" :lg="4" :xl="4">
              <div class="el_col_list el3">
                ...
                <ul v-if="item.application_data">
                  <li class="order_sum"><p>累计订单总额：</p><span style="color:#e87626;font-weight: bolder">{{toThousands(handleSum(item.application_data.loan_purpose))}}（元）</span></li>
                  <li v-if="item.application_data.loan_purpose" v-for="(el, indexChan) in item.application_data.loan_purpose" :key='indexChan' class="order_line">
                    <p>采购项目订单：</p>
                    <span v-if="el.order" v-for="(order, i) in el.order" :key='i'>
                      <div><span style="margin-right: 12px" :title='order.name'>{{order.name}}</span><span>{{toThousands(order.amount)}}（元）</span></div>
                    </span>
