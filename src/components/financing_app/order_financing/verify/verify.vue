<template>
  <div class="financing_section">
    ...
    <div class="order_application">
      ...
      <orderRisk v-if="selIndex === 0"/>
      <orderAgreement @sign='handleArgeee' v-if="selIndex === 1"/>
...
export default {
  ...
  data () {
    return {
      ...
      currentIndex: 0,
      steps: [
        {name: '风控审核反馈', icon: require('../../../../../static/img/financing/risk.png'), disicon: require('../../../../../static/img/financing/risk-d.png')},
