          ...
          <div class="form_upload">
            ...
            <div>
              <div class="upload_btn">
                ...
                <span v-if="riskStatus === '700'">+</span>
              </div>
              <ul v-if="repayment.showImg">
                <li v-for="(item, index) in repayment.showImg" :key='index'>
  ...
  created () {
    ...
    that.$ajax.get(`/api/financing/loan_process/${that.$route.query.id}/`).then(res => {
      ...
      if (res.status == 200) {
        ...
        if (!this.repayment.showImg) this.repayment.showImg = []
      }
    })
  },
  methods: {
      ...
      if (file.size > 2 * 1024 * 1024) {
        ...
        this.$ajax.post('/api/ns_file/', upload).then(res => {
          ...
          if (res.status === 200) {
            ...
            repayment.showImg.push(res.data)
