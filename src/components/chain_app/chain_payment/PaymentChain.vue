<template>
  <div class="view_chain">
    ...
    <!-- <div class="nav_chain_top" :style="element ? 'padding-bottom: 0' : ''" :class="selIndex === 0 ? 'max-topHeight' : ''" v-show="element">
              ...
              <div class="chain-container">
                ...
                <div class="second_view">
                  ...
                  <div class="second_chain">
                    ...
                    <settlement-contract ref="settlement" :chainType="`2`" :type="`2`" :id='contractIds.payment'/>
                  </div>
                </div>
              </div>
              <div class="chain-container">
