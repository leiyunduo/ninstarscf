<template>
  <div class="payableOne">
    <button class="fixed_btn" @click="toCreate"><i class="el-icon-plus"></i>创建采购记账</button>
      ...
      <div class="contract-menu__list" v-for="(item, index) in chain_list" :key="index">
        <div class="contract-menu__header">
          <div class="contract-menu--title">
            <label><img src="static/img/chain/number.png" alt="">项目编号:</label>
        ...
        <div class="contract-menu__main">
            ...
            <div class="contract-group__row" v-if='item.purchase_contract.length > 0' v-for="(v, i) in item.purchase_contract" :key="i">
              ...
              <div class="contract-group__row-item">
                ...
                <span  @click="toIndex(v.partner_company, v.has_partner_company, v.has_info)" :class="!v.has_partner_company && !v.has_info ? 'unregister' : ''" class="color_blue prefix-text">
                  <img :src="!v.has_partner_company && !v.has_info ? 'static/img/chain/linker_grey.png' : 'static/img/chain/linker_blue.png'" alt="">{{ v.partner_company_name }}
                </span>
              </div>
              <div class="contract-group__row-item">
          ...
          <div class="contract-group">
            ...
            <div class="contract-group__row" v-if="item.sales_contract.length > 0">
              ...
              <div class="contract-group__row-item">
                <label for="">合作企业:</label>
                <span @click="toIndex(item.sales_contract[0].partner_company, item.sales_contract[0].has_partner_company, item.sales_contract[0].has_info, item)" :class="!item.sales_contract[0].has_partner_company && !item.sales_contract[0].has_info ? 'unregister' : ''" class="color_orange prefix-text">
                  ...
                  <!-- <el-tooltip placement="top">
                    <div slot="content">该企业尚未在平台注册，点击可进行邀请</div>
                    <img class="prefix-icon" src="static/img/chain/invite.png">
                  </el-tooltip> -->
                </span>
              </div>
              <div class="contract-group__row-item">
...
<script>
  export default {
    ...
    methods: {
      ...
      toChain (chain_id) {
        this.$router.push({
          path: '/chain_app/payment_chain?id=' + chain_id
        })
        //this.$scrollToTop()
      },
      toIndex (id, flag, key) {
