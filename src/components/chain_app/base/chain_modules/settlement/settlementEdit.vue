    ...
    <div class="form">
        ...
        <div class="form_item">
          ...
          <div class="form_item_info">
            <div>
              ...
              <div v-if="!showTitle" class="disable">{{subData.name}}</div>
            </div>
          </div>
        </div>
        <div class="form_item">
          ...
          <div class="form_item_info">
            ...
            <div v-else>
              <el-date-picker size="mini" :disabled="true" v-model="subData.date_created" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd"></el-date-picker>
            </div>
          </div>
        </div>
      </div>
      <div class="form_line" style="border: none">
        <div class="form_item">
          ...
          <div class="form_item_info">
            <div>
              <input v-if="showTitle" type="text" v-model="subData.amount" class="input_title" placeholder="" maxlength="32">
              <div v-if="!showTitle" class="disable">{{subData.amount}}</div>
            </div>
          </div>
        </div>
        <div class="form_item">
          ...
          <div class="form_item_info">
            <div v-if="showTitle">
              <el-date-picker size="mini" v-model="subData.p_date" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd"></el-date-picker>
            </div>
            <div v-else>
              <el-date-picker size="mini" :disabled="true" v-model="subData.p_date" type="date" placeholder="选择日期" format="yyyy 年 MM 月 dd 日" value-format="yyyy-MM-dd"></el-date-picker>
            </div>
          </div>
        </div>        
      </div>
        ...
        if (res.status === 200) {
          ...
          if (that.showTitle) {
            ...
            if (res.data.status === '1') {
              let {name, date_created, amount, p_date} = res.data
              that.subData = {
                name: that.$parent.orgNav[0].name + '（变更' + that.$parent.selIndex + '）', date_created, amount, p_date
              }
            } else {
              that.subData = res.data
              that.subData.agent = res.data.agent_list
