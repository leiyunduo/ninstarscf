        ...
        <div class="chain-deposit__form chain_flex">
          <div class="chain-deposit__form__group chain-width-r3">
            <div class="chain-deposit__form__row chain-from_select">
              ...
              <el-select v-model="deposit.pay_type" size="small" @change="changeTab(deposit.pay_type)" placeholder="请选择支付方式">
            ...
            <div class="chain-deposit__form__row">
              ...
              <el-date-picker class="chain-box_warning" type="date" size="small" v-model="deposit.pay_date" placeholder="选择日期" format="yyyy - MM - dd" value-format="yyyy-MM-dd"></el-date-picker>
            </div>
            <div class="chain-deposit__form__row" v-if="Number(deposit.pay_type) > 2 ">
              <span class="chain-required-orange">*</span>
              <label for="">汇票到期日:</label>
              <el-date-picker type="date" size="small" v-model="deposit.pay_deadline" placeholder="选择日期" format="yyyy - MM - dd" value-format="yyyy-MM-dd"></el-date-picker>
            </div>
          </div>
...
export default {
  ...
  components: {
    ChainUpload, AgentInviteEdit, Agent
  },
