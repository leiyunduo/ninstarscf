        ...
        <div class="chain-deposit__form chain_flex">
          <div class="chain-deposit__form__group chain-width-r3">
             <div class="chain-deposit__form__row chain-from_select">
              ...
              <el-select v-model="deposit.pay_type" size="small"  :disabled="isDisabled.pay_type" @change="changeTab(deposit.pay_type)" placeholder="请选择支付方式">
            ...
            <div class="chain-deposit__form__row">
              ...
              <el-date-picker class="chain-box_warning" type="date" size="small" :disabled="isDisabled.pay_date" v-model="deposit.pay_date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd"></el-date-picker>
            </div>
  ...
  methods: {
    ...
    addChanges () {
      ...
      for(let item in this.deposit) {
        if (['attach_list', 'agent'].includes(item)) { 
          this.deposit[item] = []
