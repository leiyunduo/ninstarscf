        ...
        <div class="chain-order__form">
          <div class="chain-order__form__group chain_flex chain-width-r7">
            <div class="chain-order__form__row">
              ...
              <input type="text" :disabled="isDisabled.orderName" v-model="order.orderName">
            </div>
            <div class="chain-order__form__row">
              <span class="chain-required-orange">*</span>
...
export default {
  name: 'chainorderEdit',
  components: {
    ChainTable, ChainUpload, AgentInviteEdit, Agent
  },
  ...
  methods: {
    ...
    sureCommit () {
      ...
      this.orderCreate(this.contractId, params)
    },
    orderCreate(contractId, params) {
