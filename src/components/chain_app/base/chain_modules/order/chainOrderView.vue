  ...
  <div class="chain-order">
    <div class="chain-order__box">
      ...
      <div class="chain-order__box__wrap">
        ...
        <div v-if="navIndex === 0">
          <chain-order-create :contractId="contract_id" :type="type" :chainType="chain_type" :chainId="chain_id"/>
        </div>
        <div v-else-if="navIndex === 1">
          <chain-order-edit :orderId="order_id" :type="type" :chainId="chain_id" :chainType="chain_type"/>
        </div>
        <div v-else-if="navIndex === 2">
          <chain-order-modify :orderId="order_id" :type="type" :contractId="contract_id" :chainId="chain_id" :chainType="chain_type"/>
        </div>
        <div v-else>
...
import chainOrderEdit from './chainOrderEdit'
import chainOrderCreate from './chainOrderCreate'
...
export default {
  ...
  components: {
    // AppNav, 
    Location, chainOrderEdit, chainOrderModify, chainOrderInfo, chainOrderCreate
  },
  mounted () {
