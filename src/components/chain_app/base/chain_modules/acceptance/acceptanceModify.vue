      ...
      <div class="outbound_list">
        ...
        <div class="list">
          <div v-if="showIndex === buttonList.length-1 && isAdding">
            <acceptance-edit :create='create' :cid="contract_id" :ruleFormList='ruleFormList' :chainId="chain_id" :chainType="chain_type" :orderId="order_id"/>
          </div>
          <div v-else>
...
export default {
  ...
  components: {
    Location, acceptanceEdit, acceptanceList, navBar, 
    // AppNav
  },
  created() {
    var that = this
