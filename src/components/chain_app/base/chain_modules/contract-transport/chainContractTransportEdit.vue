      ...
      <div class="chain-contract__body">
        <div class="chain-contract__form">
          ...
          <div class="chain-contract__form__row">
            <span class="chain-required-orange">*</span>
            <label for="">托运方:</label>
            <input type="text" maxlength="32" :disabled="isDisabled.buy_company" @keyup="getCompanyList($event, contract.buy_company, 3)" v-model="contract.buy_company">
          ...
          <div class="chain-contract__form__row">
            ...
            <input type="text" maxlength="32" :disabled="isDisabled.buyer" v-model="contract.buyer">
          </div>
          <div class="chain-contract__form__row">
            <!-- <span class="chain-required-orange">*</span> -->
...
export default {
  ...
  props: ['chainId', 'transportId', 'chainType'],
  data () {
    return {
      disabled: true,
      step: {selIndex: 1},
  ...
  methods: {
    ...
    contractEdit (params) {
      this.$ajax.patch(`/api/chain/transport_contract/${params.transportId}/`, params).then(res => {
        if (res.status === 200) {
