  ...
  <div class="chain-contract">
    <div class="chain-contract__box">
      ...
      <div class="chain-contract__box__wrap">
        ...
        <div v-if="navIndex === 0">
          <contract-transport-create :contractId="contract_id" :chainId="chain_id" :chainType="chain_type"/>
        </div>
        <div v-else-if="navIndex === 1">
          <contract-transport-edit :chainId="chain_id" :transportId="transport_id" :chainType="chain_type" />
        </div>
        <div v-else-if="navIndex === 2">
          <contract-transport-modify :chainId="chain_id" :contractId="contract_id" :chainType="chain_type" :transportId="transport_id"/>
        </div>
        <div v-else>
          <contract-transport-info :transportId="transport_id" />
        </div>
      </div>
    </div>
  </div>
...
import ContractTransportEdit from './chainContractTransportEdit'
import ContractTransportModify from './chainContractTransportModify'
import ContractTransportCreate from './chainContractTransportCreate'
import ContractTransportInfo from './chainContractTransportInfo'
export default {
  ...
  components: {
    // AppNav, 
    Location, ContractTransportEdit, ContractTransportInfo, ContractTransportModify, ContractTransportCreate
  },
  mounted () {
  ...
  beforeCreate () {
    ...
    this.transport_id = this.$route.query.transport_id
