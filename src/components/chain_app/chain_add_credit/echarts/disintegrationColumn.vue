      ...
      let option = {
        ...
        tooltip: {
          ...
          formatter: function(params) {
            ...
            str = '<div><h3>'+ '2018年' + params[0].name +'</h3>'
            str += '<p>' + that.chartData.title + '（元）<span>：'+ that.toThousands(params[0].value) +'</span></p>'
            str +='</div>'
            return str
          }
        },
